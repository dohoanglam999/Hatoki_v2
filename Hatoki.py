...
def menu():
    sys.stdout.write(f"HaToKi Ddos Update New")
    clear()
    print('HaToKi DDoS By DoHoangLam ')
    ...
    print(Fore.YELLOW + """
            ...
            ╚═════════════════════╦═════════════════════════════════════════╦══════════════════════╝
               ...
               ║--------- Link FaceBook: https://www.facebook.com/DoHoangLam.X.Developer--------║
               ╚════════════════════════╦═══════════════════════════╦═══════════════════════════╝
                     ╔══════════════════╩═══════════════════════════╩═══════════════════╗
    ...
    while(True):
        ...
        if cnc == "layer7" or cnc == "LAYER7" or cnc == "L7" or cnc == "l7":
            ...
            try:
                ...
                print(Fore.RED +'Example: http-raw hotieubao.info/ 60')
